...
require.register("test/all.ls", function(exports, require, module) {
...
appRequire('puzzles/all');
appRequire('transactions/all');
appRequire('contracts/all');
});

;require.register("test/test-utils.ls", function(exports, require, module) {
module.exports = {
  appRequire: function(path){
    var e;
    try {
      return require(path);
    } catch (e$) {
